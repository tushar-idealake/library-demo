...
describe("FormGenericSpinnerComponent", () => {
  let component: FormGenericSpinnerComponent;
  let fixture: ComponentFixture<FormGenericSpinnerComponent>;
  let elementStyle: CSSStyleDeclaration;
  let spinnerService: FormGenericSpinnerService;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      ...
      providers: [FormGenericSpinnerService],
    }).compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(FormGenericSpinnerComponent);
    component = fixture.componentInstance;
    component.show = true;

    spinnerService = fixture.debugElement.injector.get(FormGenericSpinnerService);
    ...
    describe("when not specified", () => {
      it("should set the default background color", () => {
        ...
        elementStyle = getComputedStyle(
          fixture.nativeElement.querySelector(".form-generic-spinner-overlay")
        );
